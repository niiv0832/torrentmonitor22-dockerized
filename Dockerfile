...
RUN apk update \
    ...
    && apk --no-cache add deluge-console nginx php5-common php5-cli php5-fpm php5-curl php5-sqlite3 php5-mysql php5-pdo_sqlite php5-iconv php5-json php5-ctype php5-zip \
