...
RUN apk update \
    ...
    && apk --no-cache add nginx php7-common php7-cli php7-fpm php7-curl php7-sqlite3 php7-mysqli php7-pdo_sqlite php7-iconv php7-json php7-ctype php7-zip php7-xml \
